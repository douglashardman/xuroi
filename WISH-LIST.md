...
|---|---|---|---|---|
| A1 | Thread intelligence — auto summary | P0 | partial | Heuristic v1 on thread + `/meta.json`; LLM next |
...
| A4 | JSON-LD beyond snippet — FAQPage when Q&A | P0 | — | Beat XF's 250-char `DiscussionForumPosting` |
...
| A8 | Media pipeline — WebP/AVIF + CDN | P0 | — | WITB photos are core for PutterTalk |
| A9 | Image auto alt-text + semantic tags | P1 | — | SEO + accessibility |
| A10 | Theme contract — schema + fixtures + validator | P0 | — | Builders/AI design without marketplace |
| A11 | Event-sourced posts — full edit history | P0 | partial | Revisions stored + UI overlay on thread pages |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| B1 | Categories / nodes | P0 | All | — | 1-level nesting v1 |
| B2 | Threads (topics) | P0 | All | — | |
| B3 | Posts (replies) | P0 | All | — | |
| B4 | Thread pagination | P0 | All | — | |
| B5 | Create thread | P0 | All | — | |
| B6 | Reply to thread | P0 | All | — | |
| B7 | Quote post | P0 | All | ✓ | Reference by post ID |
| B8 | Edit own post | P0 | All | ✓ | `site.json` `posts.edit_*`; PutterTalk 30 min |
| B9 | Edit history / revisions | P0 | [XF] partial | ✓ | Clickable Edited stamp → revision overlay |
| B10 | Soft delete post/thread | P0 | All | partial | Post soft delete live; thread delete TBD |
...
| B28 | Post reactions (like) | P0 | All | ✓ | Single type v1 |
...
| B35 | Activity feed / recent posts | P1 | All | — | |
| B36 | "What's new" / unread tracking | P1 | All | — | |
| B37 | Mark forum read | P1 | All | — | |
| B38 | Mark thread read | P1 | All | — | |
| B39 | Thread watch / subscribe | P1 | All | — | |
...
| C3 | Passkeys (WebAuthn) | P0 | [XF] | ✓ | Signup, login, add on profile |
| C4 | Email magic link login | P0 | — | ✓ | Emergency parachute on /join; 15 min single-use; log/SES |
| C5 | Password login | P0 | All | ✓ | bcrypt; pairs with passkeys |
...
| C10 | Avatar upload | P1 | All | — | WebP pipeline |
...
| C18 | Display name vs username | P3 | — | — | |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| D1 | Private messages (1:1) | P2 | All | — | Defer v1 |
| D2 | Group conversations | P3 | [XF] | — | |
| D3 | PM attachments | P3 | All | — | |
| D4 | PM rules / filters | P4 | [PB] | — | |
| D7 | PM privacy setting (everyone / friends-only / off) | P1 | — | — | Per-user; friends-only gates inbound DMs; off = no DMs; pair with reserved display names (K19) |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| E1 | Moderator role | P0 | All | partial | `moderator_emails` in site.json; admin superset |
| E2 | Mod queue (approve posts) | P0 | All | — | |
| E3 | Report post / thread | P0 | All | partial | Post report + admin queue live; thread report TBD |
| E4 | Report reasons (configurable) | P1 | [PB] | — | |
| E5 | Inline mod tools | P1 | [XF] | — | |
| E6 | Ban user (temp / perm) | P0 | All | ✓ | Admin UI; clears sessions |
| E7 | IP ban | P1 | All | partial | Post IPs banned with account; cleared on restore |
| E8 | Email ban | P1 | All | — | |
| E9 | Spam scoring (basic) | P1 | [XF] | — | Rate, links, new account |
| E10 | Spam scoring (ML / Akismet) | P2 | [XF] | — | |
| E11 | Flood control / rate limits | P0 | All | partial | Post + thread create limits; Redis later |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| F1 | 5-role model (Guest/Member/Mod/Admin/Agent) | P0 | — | partial | Guest implicit; agent=actor type; mod/admin via site.json |
| F2 | Category-level permission overrides | P2 | All | partial | `access_level` on forums; admin picker |
| F3 | Private categories | P2 | All | partial | Locked rows + 403; staff rooms stealth |
...
| F8 | Staff-only areas | P2 | All | — | |
| F9 | Node tree (nested categories) | P2 | [XF] | — | 1-level v1 |
...
| G2 | WebP/AVIF conversion | P0 | [XU] | partial | WebP on upload; AVIF later |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| H1 | Full-text search (posts + threads) | P1 | All | — | Postgres FTS |
...
| H7 | Async search indexing | P0 | [XF] jobs | — | Decouple from post |
...
| H16 | Structured data (JSON-LD) | P0 | [XF] | partial | DiscussionForumPosting on threads |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| I1 | Email on reply (watched thread) | P1 | All | — | |
| I2 | Email on @mention | P1 | All | — | |
| I3 | Email digest (daily/weekly) | P2 | [SMF] | — | |
| I4 | In-app notification feed | P1 | [XF] | — | |
| I5 | Notification preferences | P1 | [XF] | — | |
| I6 | Push notifications (web push) | P3 | [XF] | — | |
| I7 | Email queue / retry | P1 | All | — | |
| I8 | Transactional email templates | P1 | — | — | Bracket/Mustache OK |
| I9 | Unsubscribe links | P1 | — | — | Legal |
...
| # | Item | Pri | Incumbent | Status | Notes |
|---|---|---|---|---|---|
| J1 | Theme contract (schema + fixtures) | P0 | [XU] | scaffolded | |
| J2 | Mustache template renderer | P0 | [XU] | — | |
| J3 | `tokens.css` design variables | P0 | [XU] | — | |
| J4 | `forum theme validate` CLI | P0 | [XU] | — | |
| J5 | `forum theme preview` CLI | P1 | [XU] | — | |
| J6 | Reference themes (classic, bare) | P0 | [XU] | — | |
| J7 | PutterTalk production theme | P0 | [XU] | stub | |
| J8 | Theme hot-reload (dev) | P2 | — | — | |
| J9 | Dark mode via tokens | P1 | — | — | |
| J10 | Mobile-responsive (contract requirement) | P0 | — | — | |
...
| K2 | Site settings (title, description) | P0 | All | partial | site.json source; read-only UI |
| K3 | Category management | P0 | All | done | Nested groups + forums; admin CRUD at `/admin/categories` |
...
| K7 | Theme activation | P0 | [XU] | — | |
| K8 | Backup / restore UI | P1 | — | — | **Critical for Doug** |
...
| K19 | Reserved display names (anti-impersonation) | P0 | — | ✓ | `reserved_display_names` in site.json; case-insensitive uniqueness; blocks admin/mod/staff names at signup |
| K19 | Contact form | P2 | [XF] | — | |
...
| L8 | Stripe (paid memberships) | P4 | [XF] | — | |
...
| M2 | Projection rebuild from events | P0 | [XU] | — | |
| M3 | Background job workers | P0 | [XF] | — | Not web-triggered only |
| M4 | Redis cache | P0 | — | — | |
| M5 | Object storage (S3/R2) | P0 | — | — | |
| M6 | Docker Compose local dev | P0 | scaffolded | — | |
| M7 | PostgreSQL 16+ | P0 | — | — | |
...
| # | Item | Pri | Status | Notes |
|---|---|---|---|---|
| P1 | Category set (see site.json) | P0 | seeded | |
...
| P7 | puttertalk.com DNS + Cloudflare | P0 | — | |
...
Peck: A6–A7, C10, D skipped, E3–E5, E9, I1–I2, I4–I5, K6, L1–L3, P6
...
All P1 items not yet done — especially I1, B21, E4, F7, G6, G11, K8, M10
...
PutterTalk launch = **~75 P0 items**. That's the real scope — not XenForo's entire surface.
