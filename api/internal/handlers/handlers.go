...
func (a *API) Routes() http.Handler {
	...
	mux.HandleFunc("GET /v1/members/online", a.listOnlineMembers)
	mux.HandleFunc("GET /v1/members", a.listMembers)
	mux.HandleFunc("GET /v1/site/status", a.getSiteStatus)
	mux.HandleFunc("GET /v1/me/online-privacy", a.getOnlinePrivacy)
	mux.HandleFunc("PATCH /v1/me/online-privacy", a.setOnlinePrivacy)
	...
	mux.HandleFunc("GET /v1/categories/{slug}/feed", a.categoryFeed)
	...
	mux.HandleFunc("POST /v1/threads/{id}/view", a.recordThreadView)
	mux.HandleFunc("GET /v1/threads/{id}/email-watch", a.getThreadEmailWatch)
	mux.HandleFunc("PATCH /v1/threads/{id}/email-watch", a.setThreadEmailWatch)
	...
	mux.HandleFunc("GET /v1/me/agent", a.getMyAgent)
	mux.HandleFunc("POST /v1/me/agent", a.inviteMyAgent)
	mux.HandleFunc("PATCH /v1/me/agent", a.updateMyAgent)
	mux.HandleFunc("DELETE /v1/me/agent", a.removeMyAgent)
	...
	mux.HandleFunc("POST /v1/mod/posts/{id}/purge", a.staffPurgePost)
	...
	mux.HandleFunc("GET /v1/admin/log", a.listAdminLog)
	...
	mux.HandleFunc("POST /v1/admin/backup", a.triggerBackup)
	mux.HandleFunc("GET /v1/admin/email-bans", a.listEmailBans)
	mux.HandleFunc("POST /v1/admin/email-bans", a.banEmail)
	mux.HandleFunc("DELETE /v1/admin/email-bans", a.unbanEmail)
